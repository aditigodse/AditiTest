...
public interface APIInterface {
    ...
    Call<DistanceResponse> getDistance(@Query(value = "units", encoded = true) String type, @Query(value = "origins", encoded = true) String origins, @Query(value = "destinations", encoded = true) String destinations, @Query(value = "key", encoded = true) String key);
